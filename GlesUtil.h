...
struct GlesUtil {
  ...
  static bool StoreTexture(GLuint tex, GLenum target,
                           GLenum minFilter, GLenum magFilter,
                           GLsizei w, GLsizei h, GLenum format, GLenum type,
                           const void *pix);
  
  //   Type: GL_VERTEX_SHADER, GL_FRAGMENT_SHADER
  static GLuint CreateShader(GLenum type, const char *source_code);
  static GLuint CreateProgram(GLuint vp, GLuint fp);
